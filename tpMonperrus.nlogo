...
breed[requirements requirement]
...
;; Repaints patches in red according to their complexity value
to repaint
  ifelse show-fitness [
    ask patches with [isTouched] [set pcolor scale-color gray fitness 0 max-fitness]
  ]
  [
    ask patches with [isTouched] [set pcolor scale-color red complexity 0 max-complexity]
  ]
end
...
to createModule
  ask patch-here [
    ...
    set complexity 1
    set isTouched true
    ask requirements-here [die]
  ]
end

;; Refines module's complexity where developpers are
to refractorModule[dev-experience]
  ifelse complexity - dev-experience > 0 [
      ...
      if isTouched and member? language master-language [
        ...
        [
          if (count neighbors with [count requirements-here > 0] > 0) [
            ...
            refractorModule dev-experience ;; behavior 2 -> developer reduce module's complexity
          ]
        ]
        [
...
;; Appends new developers and requirements
to evolve
  ask requirements [
    ask patch-here [
...
"" ""
PENS
"complexity" 1.0 0 -14070903 true "" "ifelse (count patches with [isTouched] = 0) [plot 0]\n[plot (sum [complexity] of patches with [isTouched] / count patches with [isTouched])]"
"fitness" 1.0 0 -2674135 true "" "ifelse (count patches with [isTouched] = 0) [plot 0]\n[plot (sum [fitness] of patches with [isTouched] / count patches with [isTouched])]"
"boredom" 1.0 0 -14439633 true "" "ifelse count developers = 0 [plot 0]\n[plot sum [boredom-threshold] of developers / count developers]"
...
"" ""
PENS
"High Fitness" 1.0 0 -12895429 true "" "plot count patches with [fitness > fitness-threshold]"
"High complexity" 1.0 0 -5298144 true "" "plot count patches with [complexity > complexity-threshold]"
...
"" ""
PENS
"experience" 1.0 0 -955883 true "" "ifelse count developers = 0 [plot 0]\n[\n   plot sum [experience] of developers / count developers\n]"
